...
class AppTheme {
  ...
  //  BRAND COLORS
  // ─────────────────────────────────────────────
  static const Color primary      = Color(0xFFE67E22); // Main Orange
  static const Color primaryDark  = Color(0xFFD35400); // Dark Orange
  static const Color primaryLight = Color(0xFFFFF3E0); // Cream Orange
  static const Color secondary    = Color(0xFFFF8C00); // Amber Orange
  static const Color secondaryLight = Color(0xFFFFF8E1);
  static const Color accent       = Color(0xFFFF5722); // Deep Orange
  ...
  // ─────────────────────────────────────────────
  //  CHIP / MENU COLORS (used in home screen quick access)
  // ─────────────────────────────────────────────
  static const Color chipAttendance  = Color(0xFFE67E22); // = primary
  static const Color chipHoliday    = Color(0xFF22C55E); // = success
  static const Color chipPerformance = Color(0xFFEF4444); // = error
  static const Color chipWFH        = Color(0xFFD35400); // = primaryDark
  static const Color chipNotification = Color(0xFFFF8C00); // = secondary
  ...
  //  SURFACE / BACKGROUND
  // ─────────────────────────────────────────────
  static const Color background     = Color(0xFFF5F0E8); // Cream
  static const Color cardBackground = Color(0xFFFFFFFF);
  static const Color divider        = Color(0xFFE5E7EB);
  static const Color shimmerBase    = Color(0xFFE5E7EB);
  static const Color shimmerHighlight = Color(0xFFF3F4F6);
  ...
  static const TextStyle labelBold = TextStyle(
    ...
    color: textPrimary, fontFamily: 'Poppins', letterSpacing: 0.2,
  );
  ...
  /// Orange gradient — logo / splash / FAB
  static BoxDecoration get gradientDecoration => const BoxDecoration(
        gradient: LinearGradient(
  ...
  /// Primary gradient — header avatar, sheet icon
  ...
  /// Left-bordered tip banner
  static BoxDecoration get tipDecoration => BoxDecoration(
        color: cardBackground,
        borderRadius: BorderRadius.circular(20),
  ...
  /// Danger row background
  static BoxDecoration get dangerRowDecoration => BoxDecoration(
        color: errorLight.withOpacity(0.4),
      );
}
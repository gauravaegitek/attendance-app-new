...
//         if (type == 'in') auth.inBiometric.value  = deviceId;
//         else               auth.outBiometric.value = deviceId;
...
//     if (isError) ResponseHandler.showError(apiMessage: '', fallback: message);
//     else         ResponseHandler.showSuccess(apiMessage: '', fallback: message);
//   }
...
//   });
//   @override State<_SplitHeader> createState() => _SplitHeaderState();
// }
...
//       const SizedBox(height: 12),
//       _GridChips(items: [
//         _ChipData(icon: Icons.calendar_today_rounded,         label: 'Attendance',  color: AppTheme.chipAttendance,   onTap: () => Get.toNamed('/user-summary')),
//         _ChipData(icon: Icons.beach_access_rounded,           label: 'Holidays',    color: AppTheme.chipHoliday,      onTap: () => Get.toNamed('/holidays')),
//         _ChipData(icon: Icons.bar_chart_rounded,              label: 'Performance', color: AppTheme.chipPerformance,  onTap: () => Get.toNamed('/performance')),
//         _ChipData(icon: Icons.home_work_outlined,             label: 'WFH',         color: AppTheme.chipWFH,          onTap: () => Get.toNamed('/wfh')),
//         _ChipData(icon: Icons.event_note_rounded,             label: 'Leave',       color: const Color(0xFF0D9488),   onTap: () => Get.toNamed('/leave')),
//         _ChipData(icon: Icons.devices_rounded,                label: 'My Assets',   color: const Color(0xFF6366F1),   onTap: () => Get.toNamed('/my-assets')),
//         _ChipData(icon: Icons.folder_copy_rounded,            label: 'Documents',   color: const Color(0xFF0891B2),   onTap: () => Get.toNamed('/documents')),
//         // ✅ Admin My Section → user payslip view (myPayroll: true)
//         _ChipData(
//           icon: Icons.account_balance_wallet_rounded,
//           label: 'Payroll',
//           color: const Color(0xFF10B981),
//           onTap: () => Get.toNamed('/payroll', arguments: {'myPayroll': true}),
//         ),
//       ]),
//       const SizedBox(height: 26),
...
//         _GroupRow(icon: Icons.groups_rounded,                 label: 'All Summary',          sub: 'All employee attendance',                  color: AppTheme.primary,          onTap: () => Get.toNamed('/admin'),                                        isFirst: true,  isLast: false),
//         _GroupRow(icon: Icons.home_work_outlined,             label: 'WFH Requests',         sub: 'Manage work from home approvals',           color: AppTheme.chipWFH,          onTap: () => Get.toNamed('/wfh-admin'),                                    isFirst: false, isLast: false),
//         _GroupRow(icon: Icons.event_note_rounded,             label: 'Leave Requests',       sub: 'Manage employee leave approvals',           color: const Color(0xFF0D9488),   onTap: () => Get.toNamed('/leave', arguments: {'adminPanel': true}),       isFirst: false, isLast: false),
//         _GroupRow(icon: Icons.rate_review_rounded,            label: 'Performance Reviews',  sub: 'Submit & manage employee reviews',          color: AppTheme.accent,           onTap: () => Get.toNamed('/performance/reviews'),                          isFirst: false, isLast: false),
//         _GroupRow(icon: Icons.inventory_2_rounded,            label: 'Asset Management',     sub: 'Add, assign & manage company assets',       color: const Color(0xFF7C3AED),   onTap: () => Get.toNamed('/asset-admin'),                                  isFirst: false, isLast: false),
//         _GroupRow(icon: Icons.folder_copy_rounded,            label: 'Document Management',  sub: 'Verify, reject & manage employee documents', color: const Color(0xFF0891B2),  onTap: () => Get.toNamed('/documents'),                                    isFirst: false, isLast: false),
//         // ✅ Admin Panel → full admin payroll view (no argument)
//         _GroupRow(icon: Icons.account_balance_wallet_rounded, label: 'Payroll Management',   sub: 'Process, approve & mark salaries paid',     color: const Color(0xFF10B981),   onTap: () => Get.toNamed('/payroll'),                                      isFirst: false, isLast: false),
//         _GroupRow(icon: Icons.help_outline_rounded,           label: 'Help & Support',       sub: 'Manage FAQs & contact messages',            color: AppTheme.info,             onTap: () => Get.toNamed('/help-support'),                                 isFirst: false, isLast: false),
//         _GroupRow(icon: Icons.history_rounded,                label: 'Login Log',            sub: 'View all user login sessions',              color: const Color(0xFF6366F1),   onTap: () => Get.toNamed('/login-history'),                                isFirst: false, isLast: false),
//         _GroupRow(icon: Icons.phonelink_erase_rounded,        label: 'Clear Device',         sub: 'Reset user device binding',                 color: AppTheme.error,            onTap: onDeviceClear,                                                      isFirst: false, isLast: true,  isDanger: true),
//       ]),
//       const SizedBox(height: 26),
//       const _TipBanner(),
//       const SizedBox(height: 8),
...
//   @override State<_UserContent> createState() => _UserContentState();
// }
...
//     if (isSunday) {
//       shiftLabel = 'Sunday Off'; shiftColor = const Color(0xFF6366F1);
//       shiftIcon  = Icons.weekend_rounded; badgeLabel = 'Off';
//     } else if (h < 10) {
//       shiftLabel = 'Shift Not Started'; shiftColor = AppTheme.warning;
//       shiftIcon  = Icons.schedule_rounded; badgeLabel = 'Today';
//     } else if (h < 18) {
//       shiftLabel = 'Shift In Progress'; shiftColor = AppTheme.success;
//       shiftIcon  = Icons.play_circle_outline_rounded; badgeLabel = 'Today';
//     } else {
//       shiftLabel = 'Shift Ended'; shiftColor = AppTheme.textSecondary;
//       shiftIcon  = Icons.check_circle_outline_rounded; badgeLabel = 'Today';
//     }
...
//         _ChipData(icon: Icons.event_note_rounded,             label: 'Leave',       color: const Color(0xFF0D9488),   onTap: () => Get.toNamed('/leave')),
//         _ChipData(icon: Icons.devices_rounded,                label: 'My Assets',   color: const Color(0xFF6366F1),   onTap: () => Get.toNamed('/my-assets')),
//         // User → normal user payslip view
//         _ChipData(icon: Icons.account_balance_wallet_rounded, label: 'Payroll',     color: const Color(0xFF10B981),   onTap: () => Get.toNamed('/payroll')),
//       ]),
//       const SizedBox(height: 26),
...
//               Text(DateFormat('HH:mm:ss  |  dd MMM yyyy').format(_now),
...
//                 style: TextStyle(fontSize: 11, color: shiftColor,
...
//       const SizedBox(height: 12),
//       _GroupedBox(children: [
//         _GroupRow(icon: Icons.reviews_outlined,     label: 'My Reviews',     sub: 'View your performance reviews', color: const Color(0xFF8B5CF6), onTap: () => Get.toNamed('/performance/my-reviews'), isFirst: true,  isLast: false),
//         _GroupRow(icon: Icons.help_outline_rounded, label: 'Help & Support', sub: 'FAQs and contact us',           color: AppTheme.info,           onTap: () => Get.toNamed('/help-support'),           isFirst: false, isLast: true),
//       ]),
//       const SizedBox(height: 26),
//       const _TipBanner(),
//       const SizedBox(height: 8),
...
//   const _DailyTaskCard();
//   @override State<_DailyTaskCard> createState() => _DailyTaskCardState();
// }
...
//   Color    _statusColor(String s) { switch (s.toLowerCase().trim()) { case 'completed': return AppTheme.success; case 'in progress': return const Color(0xFFF59E0B); default: return AppTheme.textSecondary; } }
//   IconData _statusIcon(String s)  { switch (s.toLowerCase().trim()) { case 'completed': return Icons.check_circle_rounded; case 'in progress': return Icons.timelapse_rounded; default: return Icons.radio_button_unchecked_rounded; } }
//   String   _statusLabel(String s) { switch (s.toLowerCase().trim()) { case 'completed': return 'Completed'; case 'in progress': return 'In Progress'; default: return 'Pending'; } }
...
//                     borderRadius: BorderRadius.circular(10)),
//                 child: Text('$completed / ${tasks.length} Done',
...
//           i, i + 4 > items.length ? items.length : i + 4));
//     }
//     return Column(
...
//                   child: Padding(
//                       padding:
//                           EdgeInsets.only(right: col < 3 ? 10 : 0),
...
//     required this.onTap, required this.isFirst, required this.isLast,
...
//                 Icon(Icons.fingerprint, color: AppTheme.primary, size: 28),
//                 SizedBox(width: 10),
//                 Text('Register Device', style: TextStyle(fontFamily: 'Poppins')),
//               ],
//             ),
//             content: Text(
//               'First time setup for ${type == 'in' ? 'Mark In' : 'Mark Out'}.'
...
//                       children: [
//                         Text(greeting, style: AppTheme.bodySmall),
//                         Obx(() => Text(widget.auth.userName.value, style: AppTheme.headline3)),
//                       ],
//                     ),
//                   ),
//                   NotificationBadge(iconColor: AppTheme.textPrimary),
...
//               sub: 'Process, approve & mark salaries paid',
//               color: const Color(0xFF10B981),
//               onTap: () => Get.toNamed('/payroll'),
//               isFirst: false,
//               isLast: false,
//             ),
//             _GroupRow(
...
//                   borderRadius: BorderRadius.circular(14),
//                 ),
//                 child: Icon(shiftIcon, color: shiftColor, size: 22),
//               ),
//               const SizedBox(width: 12),
//               Expanded(
//                 child: Column(
...
//                   child: Row(
//                     children: [
//                       Icon(Icons.inbox_rounded, color: AppTheme.textHint, size: 18),
//                       const SizedBox(width: 8),
//                       const Text(
...
//               final visible = tasks.take(2).toList();
//               final extra = tasks.length - visible.length;
...
//                           Padding(
//                             padding: const EdgeInsets.only(top: 2),
//                             child: Icon(_statusIcon(task.status), color: c, size: 16),
//                           ),
//                           const SizedBox(width: 8),
//                           Expanded(
//                             child: Column(
...
//   @override
//   Widget build(BuildContext context) {
//     return Text(text, style: AppTheme.labelBold);
//   }
// }
...
//                 crossAxisAlignment: CrossAxisAlignment.start,
//                 children: const [
//                   Text('Mark Attendance', style: AppTheme.headline3),
//                   SizedBox(height: 2),
//                   Text('Clock in or out with fingerprint', style: AppTheme.bodySmall),
//                   SizedBox(height: 8),
//                   Row(
//                     children: [
//                       _MiniTag(label: 'Mark In', color: AppTheme.success),
...
//               height: 36,
//               decoration: BoxDecoration(
//                 color: (isComingSoon ? AppTheme.textHint : color).withOpacity(0.12),
...
//             const SizedBox(height: 4),
//             Text(label, style: AppTheme.buttonText.copyWith(fontSize: 13)),
//           ],
//         ),
//       ),
//     );
...
class _HomeScreenState extends State<HomeScreen> {
  ...
  int _getCurrentUserId(AuthController auth) =>
      auth.currentUserId;

  void _showSnack(String message, {bool isError = false}) {
    if (isError) {
      ResponseHandler.showError(
          apiMessage: '', fallback: message);
    } else {
            ...
            child: Padding(
              ...
              child: Row(
                children: [
                  ...
                  Obx(() {
                    final disabled =
                        widget.auth.isLoggingOut.value;
                    return GestureDetector(
                      onTap: disabled
                          ? null
                          : widget.onLogout,
  ...
  Widget build(BuildContext context) {
    return Column(
      ...
      children: [
        ...
        // ── My Section ──
        const _SectionHeader(title: 'My Section'),
        const SizedBox(height: 10),
        _GridChips(
          items: [
            _ChipData(
        ...
        // ── Daily Tasks ──
        const _SectionHeader(title: 'Daily Tasks'),
        const SizedBox(height: 10),
        const _DailyTaskCard(),
        const SizedBox(height: 20),

        // ── Admin Panel (GRID CARDS — same style as My Section) ──
        ...
        _AdminGridChips(
          items: [
            ...
            _ChipData(
              ...
              color: AppTheme.accent,
              onTap: () =>
                  Get.toNamed('/performance/reviews'),
            ),
            _ChipData(
              icon: Icons.inventory_2_rounded,
              label: 'Assets',
...
// ═══════════════════════════════════════════
// ADMIN GRID CHIPS (4-per-row with wider cards)
// ═══════════════════════════════════════════

class _AdminGridChips extends StatelessWidget {
  final List<_ChipData> items;

  const _AdminGridChips({required this.items});
          ...
          child: Row(
            children: List.generate(4, (col) {
              if (col < entry.value.length) {
                final item = entry.value[col];
                final isDanger =
                    item.color == AppTheme.error;
                return Expanded(
                  child: Padding(
                    padding:
                        EdgeInsets.only(right: col < 3 ? 8 : 0),
                    child: GestureDetector(
                      onTap: item.onTap,
                      child: Container(
                        padding: const EdgeInsets.symmetric(
  ...
  Widget build(BuildContext context) {
    ...
    return Column(
      ...
      children: [
        ...
        const _SectionHeader(title: "Today's Shift"),
        const SizedBox(height: 10),
        Container(
          padding: const EdgeInsets.all(14),
          decoration: AppTheme.cardDecoration(),
        ...
        const _SectionHeader(title: 'More Options'),
        const SizedBox(height: 10),
        _GroupedBox(
          children: [
            _GroupRow(
              ...
              color: const Color(0xFF8B5CF6),
              onTap: () =>
                  Get.toNamed('/performance/my-reviews'),
              isFirst: true,
              isLast: false,
            ),
            _GroupRow(
...
// ═══════════════════════════════════════════
// DAILY TASK CARD  ← Refresh sirf ek baar
// ═══════════════════════════════════════════
...
class _DailyTaskCard extends StatefulWidget {
  ...
  @override
  State<_DailyTaskCard> createState() =>
      _DailyTaskCardState();
}
...
class _DailyTaskCardState extends State<_DailyTaskCard> {
  ...
  void initState() {
    super.initState();
    // ✅ Sirf ek baar fetch — koi periodic timer nahi
    _ctrl.fetchTodayMyTasks();
  }
          ...
          children: [
            Row(
              children: [
                ...
                const SizedBox(width: 6),
                // ✅ Manual refresh button — user tap kare to hi refresh ho
                Obx(
                  () => _ctrl.isLoadingToday.value
                      ? const SizedBox(
                          width: 18,
...
// ═══════════════════════════════════════════
// SECTION HEADER  (replaces plain _Label)
// ═══════════════════════════════════════════
        ...
        child: Row(
          children: [
            Container(
              ...
              decoration: BoxDecoration(
                color:
                    (isComingSoon ? AppTheme.textHint : color)
                        .withOpacity(0.12),
                borderRadius: BorderRadius.circular(11),
              ),
              child: Icon(icon,
      ...
      child: Container(
        ...
        child: Column(
          children: [
            ...
            Text(label,
                style:
                    AppTheme.buttonText.copyWith(fontSize: 13)),
          ],
        ),
      ),
    );

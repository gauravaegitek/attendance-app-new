...
//   // ── FIX 3: Admin cannot clear their own device; only other users ──
//   void _showDeviceClearDialog() {
//     final auth = Get.find<AuthController>();
//     final userIdController = TextEditingController();
//     final formKey = GlobalKey<FormState>();
...
//                     // ── FIX 3: Block clearing own device ──────────────────
//                     // auth.currentUserId → StorageService.getUserId() → plain int
...
//   // auth.currentUserId => StorageService.getUserId() => plain int getter (no .value)
...
//           isError ? Icons.error_outline : Icons.check_circle_outline,
//           color: Colors.white),
//       snackPosition: SnackPosition.TOP,   // ← FIX 1: top pe dikhega
//       margin: const EdgeInsets.all(16),
//       borderRadius: 14,
//     );
//   }
...
//     // ── FIX 1: Shift starts at 10 AM, ends at 6 PM ────────
//     final Color shiftColor;
//     final String shiftLabel;
//     final IconData shiftIcon;
//     if (hour < 10) {
...
// // ─────────────────────────────────────────────
// //  FIX 2: GRID CHIPS — 4 per row, wraps to next line
// // ─────────────────────────────────────────────
// class _ChipData {
//   final IconData icon;
//   final String label;
...
//       // ✅ "More Options" — Notifications removed, only Help & Support
//       const SizedBox(height: 26),
//       const _Label('More Options'),
//       const SizedBox(height: 12),
//       _GroupedBox(children: [
...
class _GroupedBox extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) =>
      Container(decoration: AppTheme.cardDecoration(radius: 22), child: Column(children: children));
}

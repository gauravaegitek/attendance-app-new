...
//                     SizedBox(height: 16),
//                     Text('No records found', style: AppTheme.headline3),
//                     Text('Select role & date range', style: AppTheme.bodySmall),
//                   ],
//                 ),
//               );
//             }
...
//           // ✅ Calendar Icon — sirf yahan tap karne par date picker open hoga
//           GestureDetector(
//             onTap: onTap,
//             child: Container(
...
class _AdminScreenState extends State<AdminScreen>
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      controller.fetchAllUsers();
      // ✅ fetchAdminSummary yahan se REMOVE — sirf search button pe call hogi
    });
  }
  ...
  Widget build(BuildContext context) {
    return Column(
      children: [
        ...
        Container(
          ...
          child: Column(
            children: [
              ...
              // Date Range + Search only (✅ PDF button removed)
              Row(
                children: [
                  Expanded(
                    child: _DateChip(
                  ...
                  const SizedBox(width: 10),
                  // ✅ Sirf Search Button — PDF button removed
                  Obx(() => ElevatedButton(
                        onPressed: controller.isLoadingSummary.value
                            ? null
                            : controller.fetchAdminSummary,
        ...
        // Stats Cards — ✅ sirf tab dikhao jab data ho
        Obx(() => controller.adminRecords.isEmpty
            ? const SizedBox()
            : Container(
                padding: const EdgeInsets.all(12),
        ...
        // Records List — ✅ sirf search ke baad dikhao
        Expanded(
          child: Obx(() {
            if (controller.isLoadingSummary.value) {
              return const Center(
              ...
              return const Center(
                child: Column(
                  ...
                  children: [
                    ...
                    Text('Select role & date range, then tap 🔍',
                        style: AppTheme.bodySmall),
                  ],
                ),
              );
              ...
              return const Center(
                child: Column(
                  ...
                  children: [
                    ...
                    SizedBox(height: 16),
                    Text('No records found', style: AppTheme.headline3),
                    Text('Try different filters', style: AppTheme.bodySmall),
                  ],
                ),
              );
            }

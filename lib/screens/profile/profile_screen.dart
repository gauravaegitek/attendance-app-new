...
//   Widget build(BuildContext context) {
//     return SliverAppBar(
//       expandedHeight: 210, // ✅ Increased for proper center spacing
//       pinned: true,
//       stretch: true,
...
// // ═══════════════════════════════════════════════
// //  PROFILE HEADER
// //  ✅ FIX: Centered content + email gap improved
// // ═══════════════════════════════════════════════
...
//               ),
//             ),
//             // ✅ FIX: Positioned.fill for perfect centering
//             Positioned.fill(
//               child: SafeArea(
//                 bottom: false,
//                 child: Column(
...
//                       ),
//                     ),
//                     const SizedBox(height: 4), // ✅ Slight gap after name
//                     Text(
//                       p?.email ?? '',
//                       style: TextStyle(
//                         fontSize: 11,
...
//                       ),
//                     ),
//                     const SizedBox(height: 10), // ✅ Increased gap email → badge
...
//               ),
//             ),
//             // ✅ Positioned.fill — perfect center
//             Positioned.fill(
//               child: SafeArea(
//                 bottom: false,
//                 child: Column(
...
// // ═══════════════════════════════════════════════
// //  COMPACT AVATAR
// //  ✅ FIX: Local path → Image.file | Server URL → Image.network
// // ═══════════════════════════════════════════════
// class _CompactAvatar extends StatelessWidget {
//   final ProfileController ctrl;
//   final bool hasPhoto;
...
//   // ✅ Check karo local path hai ya server URL
...
//                     // ✅ Naya pick kiya local photo — Image.file
//                     ? Image.file(
//                         File(p!.photoUrl!),
//                         fit: BoxFit.cover,
//                         errorBuilder: (_, __, ___) =>
//                             _AvatarInitial(name: p?.name ?? ''),
//                       )
//                     // ✅ Server se aaya photo — Image.network
//                     : Image.network(
//                         p!.photoUrl!,
//                         fit: BoxFit.cover,
//                         errorBuilder: (_, __, ___) =>
...
//                         label: 'Role',
//                         value:
//                             (ctrl.profile.value?.role ?? '—').toLowerCase(),
//                         valueColor: AppTheme.primary,
//                       ),
//                       if (ctrl.profile.value?.joiningDate?.isNotEmpty ==
//                           true) ...[
